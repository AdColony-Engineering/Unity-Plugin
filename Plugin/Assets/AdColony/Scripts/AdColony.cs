...
#region Internal Methods - do not call these
        ...
        public void _OnConfigure(string paramJson) {
            ...
            if (zoneJsonList == null) {
                Debug.LogError("Unable to parse parameters in _OnConfigure, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnRequestInterstitial(string paramJson) {
            ...
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnRequestInterstitial, " + (paramJson == null ? "null" : paramJson));
                return;
            }

            InterstitialAd ad = GetAdFromHashtable(values);
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnRequestInterstitial, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnRequestInterstitialFailed(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnRequestInterstitialFailed, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnOpened(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnOpened, " + (paramJson == null ? "null" : paramJson));
                return;
            }

            InterstitialAd ad = GetAdFromHashtable(values);
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnOpened, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnClosed(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnClosed, " + (paramJson == null ? "null" : paramJson));
                return;
            }

            InterstitialAd ad = GetAdFromHashtable(values);
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnClosed, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnExpiring(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnExpiring, " + (paramJson == null ? "null" : paramJson));
                return;
            }

            InterstitialAd ad = GetAdFromHashtable(values);
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnExpiring, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnAudioStarted(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnAudioStarted, " + (paramJson == null ? "null" : paramJson));
                return;
            }

            InterstitialAd ad = GetAdFromHashtable(values);
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnAudioStarted, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnAudioStopped(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnAudioStopped, " + (paramJson == null ? "null" : paramJson));
                return;
            }

            InterstitialAd ad = GetAdFromHashtable(values);
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnAudioStopped, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnLeftApplication(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnLeftApplication, " + (paramJson == null ? "null" : paramJson));
                return;
            }

            InterstitialAd ad = GetAdFromHashtable(values);
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnLeftApplication, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnClicked(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnClicked, " + (paramJson == null ? "null" : paramJson));
                return;
            }

            InterstitialAd ad = GetAdFromHashtable(values);
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnClicked, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnIAPOpportunity(string paramJson) {
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnIAPOpportunity, " + (paramJson == null ? "null" : paramJson));
                return;
            }
            ...
            if (ad == null) {
                Debug.LogError("Unable to create ad within _OnIAPOpportunity, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnRewardGranted(string paramJson) {
            ...
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnRewardGranted, " + (paramJson == null ? "null" : paramJson));
                return;
            }
        ...
        public void _OnCustomMessageReceived(string paramJson) {
            ...
            Hashtable values = (AdColonyJson.Decode(paramJson) as Hashtable);
            if (values == null) {
                Debug.LogError("Unable to parse parameters in _OnCustomMessageReceived, " + (paramJson == null ? "null" : paramJson));
                return;
            }
